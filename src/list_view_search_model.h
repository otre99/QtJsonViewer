...
public:
  ...
  explicit ListViewSearchModel(JsonTreeViewModel *lm, QObject *parent = nullptr);

  int rowCount(const QModelIndex &parent = QModelIndex()) const override final;
  int columnCount(const QModelIndex &parent = QModelIndex()) const override final;
  QVariant data(const QModelIndex &idx, int role) const override final;
  void doSearch(SearchMode mode, const QString &searchText, bool caseSensitive, bool wholeWord, bool useRegex);
